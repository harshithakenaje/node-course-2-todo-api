...
describe('GET /todos/:id', () => {
  ...
  it('should not return todo doc to other user', (done) => {
    request(app)
...
describe('POST /user',()=>{
  ...
  it('should not create new user if email exists',(done)=>{
     var email = 'jack@example.com';
     var password = 'hello1233';
...
describe('DELETE/user/me/token',()=>{
  it('Should remove auth when logout',(done)=>{
    request(app)
